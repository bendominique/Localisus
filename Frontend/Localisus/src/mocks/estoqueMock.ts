...
export const estoqueMock = [
    ...
    {id: 2, quantidade: 100, medicamentoId: 2, hospitalId: 2, validadeLote: new Date('2026-05-12'), codigoLote: 1234 },
    {id: 3, quantidade: 100, medicamentoId: 3, hospitalId: 2,  validadeLote: new Date('2026-05-12'), codigoLote: 123456 }
]